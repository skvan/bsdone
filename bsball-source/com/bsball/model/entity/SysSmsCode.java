...
extends BaseEntity {
    ...
    public String toString() {
        return "SysSmsCode(tenantId=" + this.getTenantId() + ", phone=" + this.getPhone() + ", code=" + this.getCode() + ", scene=" + this.getScene() + ", clientIp=" + this.getClientIp() + ", expiresAt=" + String.valueOf(this.getExpiresAt()) + ", usedAt=" + String.valueOf(this.getUsedAt()) + ")";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SysSmsCode)) {
            return false;
        }
        SysSmsCode other = (SysSmsCode)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SysSmsCode;
    }

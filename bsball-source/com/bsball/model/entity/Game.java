...
extends BaseEntity {
    ...
    @Comment(value="\u4e3b\u961f\u6bcf\u5c40\u5f97\u5206")
    private String homeScoreByInning;
    @Column(columnDefinition="TEXT")
    @Comment(value="\u5ba2\u961f\u6bcf\u5c40\u5f97\u5206")
    private String awayScoreByInning;
    @Comment(value="\u603b\u5c40\u6570")
    ...
    @Comment(value="\u5173\u8054\u7403\u573a ID\uff08\u95e8\u6237\u94fe\u5230\u7403\u573a\u4ecb\u7ecd\uff09")
    ...
    @Column(columnDefinition="TEXT")
    @Comment(value="\u5b9e\u65f6\u5f55\u5165\u5feb\u7167 JSON")
    private String liveSnapshotJson;
    @Comment(value="\u89c2\u4f17\u4eba\u6570\uff08\u53ef\u7a7a\uff09")
    private Integer spectatorCount;
    @Column(length=128)
    @Size(max=128)
    @Comment(value="\u4e3b\u5ba1")
    private @Size(max=128) String umpireHp;
    @Column(length=128)
    @Size(max=128)
    @Comment(value="\u4e00\u5792\u5ba1")
    private @Size(max=128) String umpire1b;
    @Column(length=128)
    @Size(max=128)
    @Comment(value="\u4e8c\u5792\u5ba1")
    private @Size(max=128) String umpire2b;
    @Column(length=128)
    @Size(max=128)
    @Comment(value="\u4e09\u5792\u5ba1")
    private @Size(max=128) String umpire3b;
    @Column(length=500)
    @Size(max=500)
    @Comment(value="\u8bb0\u5f55\u5458\uff0c\u591a\u4eba\u53ef\u7528\u9017\u53f7\u6216\u987f\u53f7\u5206\u9694")
    private @Size(max=500) String recorders;
    @Column(length=64)
    @Size(max=64)
    @Comment(value="\u573a\u6b21\u6807\u7b7e\uff0c\u5982\u51a0\u519b\u8d5b\uff1b\u6709\u503c\u65f6\u524d\u53f0\u663e\u793a\u5956\u676f\u6807\u8bc6")
    private @Size(max=64) String gameTag;
    @Column(length=200)
    @Size(max=200)
    @Comment(value="\u5929\u6c14\u7b80\u51b5")
    private @Size(max=200) String weatherSummary;
    @Comment(value="\u6c14\u6e29\uff08\u6444\u6c0f\u5ea6\uff09")
    private Double weatherTempC;
    @Column(length=128)
    @Size(max=128)
    @Comment(value="\u98ce\u901f/\u98ce\u5411\u63cf\u8ff0")
    private @Size(max=128) String weatherWind;
    @Comment(value="\u8d5b\u524d\u9884\u62a5\u964d\u96e8\u6982\u7387 0-100")
    ...
    @Comment(value="\u662f\u5426\u4e3a\u7279\u6b8a\u6bd4\u8d5b\uff08\u5982\u4e0d\u8db3\u4eba\u6570\u5224\u8d1f\u7b49\uff09")
    private Boolean isSpecialResult = false;
    @Comment(value="\u662f\u5426\u5c06\u5907\u6ce8\u663e\u793a\u5728\u6bd4\u8d5b\u7ed3\u679c\u5361\u7247\u4e2d")
    private Boolean showRemarkInCard = false;
    @Comment(value="\u662f\u5426\u5c06\u672c\u573a\u6bd4\u8d5b\u7403\u5458\u6570\u636e\u8ba1\u5165\u7edf\u8ba1\u6392\u884c")
    private Boolean includeStatsInRanking = true;
    @Comment(value="\u6bd4\u8d5b\u6a21\u5f0f: BASEBALL \u68d2\u7403 / SOFTBALL \u5792\u7403")
    private String gameMode = "BASEBALL";

    @JsonProperty
    public void setHomeScoreByInning(Object raw) {
        this.homeScoreByInning = Game.toInningJson((Object)raw);
    }

    @JsonProperty
    public void setAwayScoreByInning(Object raw) {
        this.awayScoreByInning = Game.toInningJson((Object)raw);
    }

    private static String toInningJson(Object raw) {
        if (raw == null) {
            return null;
        }
    ...
    @Generated
    public String getHomeScoreByInning() {
        return this.homeScoreByInning;
    }

    @Generated
    public String getAwayScoreByInning() {
    ...
    public String toString() {
        return "Game(eventId=" + this.getEventId() + ", tenantId=" + this.getTenantId() + ", homeTeamId=" + this.getHomeTeamId() + ", awayTeamId=" + this.getAwayTeamId() + ", homeScore=" + this.getHomeScore() + ", awayScore=" + this.getAwayScore() + ", homeScoreByInning=" + this.getHomeScoreByInning() + ", awayScoreByInning=" + this.getAwayScoreByInning() + ", totalInnings=" + this.getTotalInnings() + ", homeH=" + this.getHomeH() + ", awayH=" + this.getAwayH() + ", homeE=" + this.getHomeE() + ", awayE=" + this.getAwayE() + ", gameTime=" + this.getGameTime() + ", gameEndTime=" + this.getGameEndTime() + ", gameday=" + this.getGameday() + ", gameNumber=" + this.getGameNumber() + ", stadiumId=" + this.getStadiumId() + ", venue=" + this.getVenue() + ", status=" + this.getStatus() + ", inning=" + this.getInning() + ", topBottom=" + this.getTopBottom() + ", liveSnapshotJson=" + this.getLiveSnapshotJson() + ", spectatorCount=" + this.getSpectatorCount() + ", umpireHp=" + this.getUmpireHp() + ", umpire1b=" + this.getUmpire1b() + ", umpire2b=" + this.getUmpire2b() + ", umpire3b=" + this.getUmpire3b() + ", recorders=" + this.getRecorders() + ", gameTag=" + this.getGameTag() + ", weatherSummary=" + this.getWeatherSummary() + ", weatherTempC=" + this.getWeatherTempC() + ", weatherWind=" + this.getWeatherWind() + ", weatherRainProbPct=" + this.getWeatherRainProbPct() + ", remark=" + this.getRemark() + ", isSpecialResult=" + this.getIsSpecialResult() + ", showRemarkInCard=" + this.getShowRemarkInCard() + ", includeStatsInRanking=" + this.getIncludeStatsInRanking() + ", gameMode=" + this.getGameMode() + ")";
    }
    ...
    public boolean equals(Object o) {
        ...
        String this$homeScoreByInning = this.getHomeScoreByInning();
        String other$homeScoreByInning = other.getHomeScoreByInning();
        if (this$homeScoreByInning == null ? other$homeScoreByInning != null : !this$homeScoreByInning.equals(other$homeScoreByInning)) {
            return false;
        }
        String this$awayScoreByInning = this.getAwayScoreByInning();
        String other$awayScoreByInning = other.getAwayScoreByInning();
        ...
        String this$liveSnapshotJson = this.getLiveSnapshotJson();
        String other$liveSnapshotJson = other.getLiveSnapshotJson();
        if (this$liveSnapshotJson == null ? other$liveSnapshotJson != null : !this$liveSnapshotJson.equals(other$liveSnapshotJson)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        String $homeScoreByInning = this.getHomeScoreByInning();
        result = result * 59 + ($homeScoreByInning == null ? 43 : $homeScoreByInning.hashCode());
        String $awayScoreByInning = this.getAwayScoreByInning();
        ...
        String $liveSnapshotJson = this.getLiveSnapshotJson();
        result = result * 59 + ($liveSnapshotJson == null ? 43 : $liveSnapshotJson.hashCode());

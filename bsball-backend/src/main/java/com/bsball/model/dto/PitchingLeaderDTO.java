...
public class PitchingLeaderDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PitchingLeaderDTO)) {
            return false;
        }
        PitchingLeaderDTO other = (PitchingLeaderDTO)o;
        ...
        Double this$whip = this.getWhip();
        Double other$whip = other.getWhip();
        if (this$whip == null ? other$whip != null : !((Object)this$whip).equals(other$whip)) {
            return false;
        }
        Double this$era = this.getEra();
        Double other$era = other.getEra();
        if (this$era == null ? other$era != null : !((Object)this$era).equals(other$era)) {
            return false;
        }
        ...
        Double this$goFo = this.getGoFo();
        Double other$goFo = other.getGoFo();
        if (this$goFo == null ? other$goFo != null : !((Object)this$goFo).equals(other$goFo)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PitchingLeaderDTO;
    }
    ...
    public int hashCode() {
        ...
        Double $whip = this.getWhip();
        result = result * 59 + ($whip == null ? 43 : ((Object)$whip).hashCode());
        Double $era = this.getEra();
        result = result * 59 + ($era == null ? 43 : ((Object)$era).hashCode());
        ...
        Double $goFo = this.getGoFo();
        result = result * 59 + ($goFo == null ? 43 : ((Object)$goFo).hashCode());
    ...
    public String toString() {
        return "PitchingLeaderDTO(playerId=" + this.getPlayerId() + ", playerName=" + this.getPlayerName() + ", teamId=" + this.getTeamId() + ", teamName=" + this.getTeamName() + ", position=" + this.getPosition() + ", number=" + this.getNumber() + ", gp=" + this.getGp() + ", gs=" + this.getGs() + ", svo=" + this.getSvo() + ", cg=" + this.getCg() + ", pg=" + this.getPg() + ", w=" + this.getW() + ", l=" + this.getL() + ", sv=" + this.getSv() + ", hld=" + this.getHld() + ", ip=" + this.getIp() + ", whip=" + this.getWhip() + ", era=" + this.getEra() + ", pitchPa=" + this.getPitchPa() + ", pitchBf=" + this.getPitchBf() + ", np=" + this.getNp() + ", pitchH=" + this.getPitchH() + ", pitchHr=" + this.getPitchHr() + ", pitchInsideParkHr=" + this.getPitchInsideParkHr() + ", pitchBb=" + this.getPitchBb() + ", pitchIbb=" + this.getPitchIbb() + ", pitchHbp=" + this.getPitchHbp() + ", pitchSo=" + this.getPitchSo() + ", wp=" + this.getWp() + ", bk=" + this.getBk() + ", pitchR=" + this.getPitchR() + ", er=" + this.getEr() + ", go=" + this.getGo() + ", fo=" + this.getFo() + ", goFo=" + this.getGoFo() + ")";
    }
}

...
public class EventStatRow {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EventStatRow)) {
            return false;
        }
        EventStatRow other = (EventStatRow)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EventStatRow;
    }
